...
set(Qt5VirtualKeyboard_VERSION_STRING 5.13.2)
...
macro(_populate_VirtualKeyboard_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::VirtualKeyboard PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5VirtualKeyboard.lib.so"
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.13.2"
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.13.2/QtVirtualKeyboard"
    )
    ...
    foreach(_module_dep ${_Qt5VirtualKeyboard_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.2 ${_Qt5VirtualKeyboard_FIND_VERSION_EXACT}
