...
set(Qt5EglSupport_VERSION_STRING 5.13.2)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5EglSupport_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5EglSupport_${Configuration}_${_lib}_PATH ${_lib})
...
if (NOT TARGET Qt5::EglSupport)
    ...
    set(Qt5EglSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EglSupport_install_prefix}/include/QtEglSupport/5.13.2"
        "${_qt5EglSupport_install_prefix}/include/QtEglSupport/5.13.2/QtEglSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EglSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.2 ${_Qt5EglSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_EglSupport_process_prl_file(
            "${_qt5EglSupport_install_prefix}/lib/libQt5EglSupport.prl" RELEASE
    ...
    _populate_EglSupport_target_properties(RELEASE "libQt5EglSupport.a" "" FALSE)
