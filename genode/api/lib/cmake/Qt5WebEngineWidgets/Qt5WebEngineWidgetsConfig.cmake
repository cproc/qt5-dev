...
set(Qt5WebEngineWidgets_VERSION_STRING 5.14.2)
...
macro(_populate_WebEngineWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::WebEngineWidgets PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5WebEngineWidgets.lib.so"
...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    set(Qt5WebEngineWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.14.2"
        "${_qt5WebEngineWidgets_install_prefix}/include/QtWebEngineWidgets/5.14.2/QtWebEngineWidgets"
    )
    ...
    set(_Qt5WebEngineWidgets_MODULE_DEPENDENCIES "WebEngineCore;Quick;Widgets;Gui;Network;Core")
    ...
    foreach(_module_dep ${_Qt5WebEngineWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5WebEngineWidgets_FIND_VERSION_EXACT}
