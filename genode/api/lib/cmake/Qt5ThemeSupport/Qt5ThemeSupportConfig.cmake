...
set(Qt5ThemeSupport_VERSION_STRING 5.13.2)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5ThemeSupport_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5ThemeSupport_${Configuration}_${_lib}_PATH ${_lib})
...
if (NOT TARGET Qt5::ThemeSupport)
    ...
    set(Qt5ThemeSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5ThemeSupport_install_prefix}/include/QtThemeSupport/5.13.2"
        "${_qt5ThemeSupport_install_prefix}/include/QtThemeSupport/5.13.2/QtThemeSupport"
    )
    ...
    foreach(_module_dep ${_Qt5ThemeSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.2 ${_Qt5ThemeSupport_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_ThemeSupport_process_prl_file(
            "${_qt5ThemeSupport_install_prefix}/lib/libQt5ThemeSupport.prl" RELEASE
