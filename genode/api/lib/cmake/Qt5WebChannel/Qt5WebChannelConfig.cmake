...
set(Qt5WebChannel_VERSION_STRING 5.13.2)
...
macro(_populate_WebChannel_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::WebChannel PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5WebChannel.lib.so"
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/QtWebChannel/5.13.2"
        "${_qt5WebChannel_install_prefix}/include/QtWebChannel/5.13.2/QtWebChannel"
    )
    ...
    foreach(_module_dep ${_Qt5WebChannel_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.2 ${_Qt5WebChannel_FIND_VERSION_EXACT}
    ...
    _populate_WebChannel_target_properties(RELEASE "libQt5WebChannel.lib.so" "" FALSE)
