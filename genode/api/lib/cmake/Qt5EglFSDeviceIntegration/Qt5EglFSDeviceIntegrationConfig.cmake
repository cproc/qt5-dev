...
macro(_populate_EglFSDeviceIntegration_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::EglFSDeviceIntegration PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5EglFSDeviceIntegration.lib.so"
...
if (NOT TARGET Qt5::EglFSDeviceIntegration)
    ...
    set(_Qt5EglFSDeviceIntegration_MODULE_DEPENDENCIES "EventDispatcherSupport;ServiceSupport;ThemeSupport;FontDatabaseSupport;FbSupport;EglSupport;PlatformCompositorSupport;Gui;Gui;DeviceDiscoverySupport;Core;Core")
